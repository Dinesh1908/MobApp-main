...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MobileApplication.Product", mendixObject.getType()))
			return mobileapplication.proxies.Product.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MobileApplication.ProductBannerImage", mendixObject.getType()))
			return mobileapplication.proxies.ProductBannerImage.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MobileApplication.ProductFeatureImage", mendixObject.getType()))
